...
$transpose = $_GET['transpose'] ? $_GET['transpose'] : 0;
...
else
{
	...
	{		
		...
		if (strpos($info, 'mng-') !== false)
		{
			...
			$head .= "\t" .
				...
				"mtm-601\tmtm-300\tmtm-301\tmtm-302\tmtm-303\tmtm-304\tmtm-305\tmtm-306\tmtm-307\tmtm-10\tmtm-11\tmtm-110\tmtm-200\tmtm-201\tmtm-202\tmtm-12\t" .
				"mwn-0\tmwn-1\tmwn-2\tmwn-3\tmwn-4\tmwn-5\tmwn-6\tmwn-100\tmwn-101\tmwn-102\tmwn-103\tmwn-104\tmwn-105\t" .
				"mwn-601\tmwn-300\tmwn-301\tmwn-302\tmwn-303\tmwn-304\tmwn-305\tmwn-306\tmwn-307\tmwn-10\tmwn-11\tmwn-110\tmwn-200\tmwn-201\tmwn-202\tmwn-12\t" .
				"mls-0\tmls-1\tmls-2\tmls-3\tmls-4\tmls-5\tmls-6\tmls-100\tmls-101\tmls-102\tmls-103\tmls-104\tmls-105\t" .
				"mls-601\tmls-300\tmls-301\tmls-302\tmls-303\tmls-304\tmls-305\tmls-306\tmls-307\tmls-10\tmls-11\tmls-110\tmls-200\tmls-201\tmls-202\tmls-12\t" .
				"mbs-0\tmbs-1\tmbs-2\tmbs-3\tmbs-4\tmbs-5\tmbs-6\tmbs-100\tmbs-101\tmbs-102\tmbs-103\tmbs-104\tmbs-105\t" .
				"mbs-601\tmbs-300\tmbs-301\tmbs-302\tmbs-303\tmbs-304\tmbs-305\tmbs-306\tmbs-307\tmbs-10\tmbs-11\tmbs-110\tmbs-200\tmbs-201\tmbs-202\tmbs-12\t" .
				"mws-0\tmws-1\tmws-2\tmws-3\tmws-4\tmws-5\tmws-6\tmws-100\tmws-101\tmws-102\tmws-103\tmws-104\tmws-105\t" .
				"mws-601\tmws-300\tmws-301\tmws-302\tmws-303\tmws-304\tmws-305\tmws-306\tmws-307\tmws-10\tmws-11\tmws-110\tmws-200\tmws-201\tmws-202\tmws-12\t" .
		...
		if (!$row) {
			...
			// Favorite weapon
			$query = "SELECT time0, time1, time2, time3, time4, time5, time6 FROM weapons WHERE id = {$pid}";
			$result = mysql_query($query) or die(mysql_error());
			$row2 = mysql_fetch_array($result);
			arsort($row2);
		...
		$info == 'mtm-,mwn-,mls-,cmap-' || $info == 'mtm-,mwn-,mls-,mbs-,mws-,cmap-')
	{
		...
		$head .= "H\tpid\tnick\tmtm-0\tmtm-1\tmtm-2\tmtm-3\tmtm-4\tmtm-5\tmtm-6\tmtm-100\tmtm-101\tmtm-102\tmtm-103\tmtm-104\tmtm-105\t" .
			"mtm-601\tmtm-300\tmtm-301\tmtm-302\tmtm-303\tmtm-304\tmtm-305\tmtm-306\tmtm-307\tmtm-10\tmtm-11\tmtm-110\tmtm-200\tmtm-201\tmtm-202\tmtm-12\t" .
			"mwn-0\tmwn-1\tmwn-2\tmwn-3\tmwn-4\tmwn-5\tmwn-6\tmwn-100\tmwn-101\tmwn-102\tmwn-103\tmwn-104\tmwn-105\t" .
			"mwn-601\tmwn-300\tmwn-301\tmwn-302\tmwn-303\tmwn-304\tmwn-305\tmwn-306\tmwn-307\tmwn-10\tmwn-11\tmwn-110\tmwn-200\tmwn-201\tmwn-202\tmwn-12\t" .
			"mls-0\tmls-1\tmls-2\tmls-3\tmls-4\tmls-5\tmls-6\tmls-100\tmls-101\tmls-102\tmls-103\tmls-104\tmls-105\t" .
