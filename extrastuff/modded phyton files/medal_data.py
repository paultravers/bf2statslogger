...
medal_data = (
	...
	#Badges - Infantry
		#Knife Combat Badge
			...
			#Veteran
			('1031406_2',	'kcb',	1, f_and( 	has_medal ('1031406_1'),
												f_plus(	global_stat ('wkl-9'),
													object_stat ('weapons', 'kills', WEAPON_TYPE_KNIFE), 50))),

			#Expert	
			('1031406_3',	'kcb',	1, f_and( 	has_medal ('1031406_2'),
												f_plus(	global_stat ('wkl-9'),
													object_stat ('weapons', 'kills', WEAPON_TYPE_KNIFE), 100))),

		#Pistol Combat Badge
			#Basic
			('1031619_1', 'pcb',	1, object_stat ('weapons', 'kills', WEAPON_TYPE_PISTOL, 7)),
		...
		#Assault Combat Badge
			...
			#Veteran
			('1031119_2', 'Acb',	1, f_and( 	has_medal ('1031119_1'),
												global_stat ('ktm-1', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_ASSAULT, 20))),

			#Expert
			('1031119_3', 'Acb',	1, f_and( 	has_medal ('1031119_2'),
												global_stat ('ktm-1', 14400),
		...
		#Anti-Tank Combat Badge
			...
			#Veteran
			('1031120_2', 'Atcb',	1, f_and( 	has_medal ('1031120_1'),
												global_stat ('ktm-0', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_AT, 20))),

			#Expert
			('1031120_3', 'Atcb',	1, f_and( 	has_medal ('1031120_2'),
												global_stat ('ktm-0', 14400),
		...
		#Sniper Combat Badge
			...
			#Veteran
			('1031109_2', 'Sncb',	1, f_and( 	has_medal ('1031109_1'),
												global_stat ('ktm-6', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_SNIPER, 15))),

			#Expert
			('1031109_3', 'Sncb',	1, f_and( 	has_medal ('1031109_2'),
												global_stat ('ktm-6', 14400),
		...
		#Spec Ops Combat Badge
			...
			#Veteran
			('1031115_2', 'Socb',	1, f_and( 	has_medal ('1031115_1'),
												global_stat ('ktm-4', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_SPECOPS, 20))),

			#Expert
			('1031115_3', 'Socb',	1, f_and( 	has_medal ('1031115_2'),
												global_stat ('ktm-4', 14400),
		...
		#Support Combat Badge
			...
			#Veteran
			('1031121_2', 'Sucb',	1, f_and( 	has_medal ('1031121_1'),
												global_stat ('ktm-5', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_SUPPORT, 20))),

			#Expert
			('1031121_3', 'Sucb',	1, f_and( 	has_medal ('1031121_2'),
												global_stat ('ktm-5', 14400),
		...
		#Engineer Combat Badge
			...
			#Veteran
			('1031105_2', 'Ecb',	1, f_and( 	has_medal ('1031105_1'),
												global_stat ('ktm-2', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_ENGINEER, 20))),

			#Expert
			('1031105_3', 'Ecb',	1, f_and( 	has_medal ('1031105_2'),
												global_stat ('ktm-2', 14400),
		...
		#Medic Combat Badge
			...
			#Veteran
			('1031113_2', 'Mcb',	1, f_and( 	has_medal ('1031113_1'),
												global_stat ('ktm-3', 3600),
												object_stat ('kits', 'kills', KIT_TYPE_MEDIC, 20))),

			#Expert
			('1031113_3', 'Mcb',	1, f_and( 	has_medal ('1031113_2'),
												global_stat ('ktm-3', 14400),
												object_stat ('kits', 'kills', KIT_TYPE_MEDIC, 40))),

		#Explosive Ordinance Badge
			#Basic
			('1032415_1', 'Eob',	1,	f_plus(	object_stat ('weapons', 'kills', WEAPON_TYPE_C4),
												f_plus(		object_stat ('weapons', 'kills', WEAPON_TYPE_ATMINE),
															object_stat ('weapons', 'kills', WEAPON_TYPE_CLAYMORE)), 5)),
												

			#Veteran
			('1032415_2', 'Eob',	1, f_and( 	has_medal ('1032415_1'),								
												global_stat ('wkl-11', 50),
												f_plus(	object_stat ('weapons', 'kills', WEAPON_TYPE_C4),
														f_plus(	object_stat ('weapons', 'kills', WEAPON_TYPE_ATMINE),
																object_stat ('weapons', 'kills', WEAPON_TYPE_CLAYMORE)), 20))),

			#Expert
			('1032415_3', 'Eob',	1, f_and( 	has_medal ('1032415_2'),
												global_stat ('wkl-11', 100),
												f_plus(	object_stat ('weapons', 'kills', WEAPON_TYPE_C4),
														f_plus(	object_stat ('weapons', 'kills', WEAPON_TYPE_ATMINE),
																object_stat ('weapons', 'kills', WEAPON_TYPE_CLAYMORE)), 30))),

		#First Aid Badge
			#Basic
			('1190601_1', 'Fab',	1, player_score ('heals', 2)),

			#Veteran
			('1190601_2', 'Fab',	1, f_and( 	has_medal ('1190601_1'),
												global_stat ('ktm-3', 3600),
												player_score ('heals', 5))),

			#Expert
			('1190601_3', 'Fab',	1, f_and( 	has_medal ('1190601_2'),
												global_stat ('heal', 50),
												global_stat ('ktm-3', 14400),
		...
		#Engineer Badge
			#Basic
			('1190507_1', 'Eb',	1, player_score ('repairs', 2)),

			#Veteran
			('1190507_2', 'Eb',	1, f_and( 	has_medal ('1190507_1'),
											global_stat ('ktm-2', 3600),
											player_score ('repairs', 5))),

			#Expert
			('1190507_3', 'Eb',	1, f_and( 	has_medal ('1190507_2'),
											global_stat ('rpar', 50),
											global_stat ('ktm-2', 14400),
		...
		#Resupply Badge
			#Basic
			('1191819_1', 'Rb',	1, player_score ('ammos', 2)),

			#Veteran
			('1191819_2', 'Rb',	1, f_and( 	has_medal ('1191819_1'),
											global_stat ('ktm-5', 3600),
											player_score ('ammos', 5))),

			#Expert
			('1191819_3', 'Rb',	1, f_and( 	has_medal ('1191819_2'),
											global_stat ('rsup', 50),
											global_stat ('ktm-5', 14400),
											player_score ('ammos', 15))),

		#Command Badge
			#Basic
			('1190304_1', 'Cb',	1, player_score ('cmdScore', 20)),

			#Veteran
			('1190304_2', 'Cb',	1, f_and( 	has_medal ('1190304_1'),
											global_stat ('cdsc', 100),
											player_stat ('timeAsCmd', 150))),

			#Expert
			('1190304_3', 'Cb',	1, f_and( 	has_medal ('1190304_2'),
											global_stat ('cdsc', 1000),
											player_stat ('timeAsCmd', 1000))),

	#Badges - Vehicles
		#Armour Badge
			#Basic
			('1220118_1', 'Ab',	1, object_stat ('vehicles', 'rtime', VEHICLE_TYPE_ARMOR, 100)),

			#Veteran
			('1220118_2', 'Ab',	1, f_and( 	has_medal ('1220118_1'),
											global_stat ('vtm-0', 7200),
											object_stat ('vehicles', 'kills', VEHICLE_TYPE_ARMOR, 12))),

			#Expert
			('1220118_3', 'Ab',	1, f_and( 	has_medal ('1220118_2'),
											global_stat ('vtm-0', 18000),
											object_stat ('vehicles', 'kills', VEHICLE_TYPE_ARMOR, 24))),

		#Transport Badge
			#Basic
			('1222016_1', 'Tb',	1, object_stat ('vehicles', 'rtime', VEHICLE_TYPE_TRANSPORT, 100)),

			#Veteran
			('1222016_2', 'Tb',	1, f_and( 	has_medal ('1222016_1'),
											global_stat ('vtm-4', 3600),
											global_stat ('dsab', 5),
											object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_TRANSPORT, 5))),

			#Expert
			('1222016_3', 'Tb',	1, f_and( 	has_medal ('1222016_2'),
											global_stat ('vtm-4', 7200),
											global_stat ('dsab', 10),
											object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_TRANSPORT, 10))),
		...
		#Helicopter Badge
			...
			#Veteran
			('1220803_2', 'Hb',	1, f_and( 	has_medal ('1220803_1'),
								global_stat ('vtm-3', 3600),
								object_stat ('vehicles', 'kills', VEHICLE_TYPE_HELICOPTER, 12))),

			#Expert
			('1220803_3', 'Hb',	1, f_and( 	has_medal ('1220803_2'),
								global_stat ('vtm-3', 18000),
		...
		#Aviator Badge
			...
			#Veteran
			('1220122_2', 'Avb',	1, f_and( 	has_medal ('1220122_1'),
												global_stat ('vtm-1', 3600),
												object_stat ('vehicles', 'kills', VEHICLE_TYPE_AVIATOR, 12))),

			#Expert
			('1220122_3', 'Avb',	1, f_and( 	has_medal ('1220122_2'),
												global_stat ('vtm-1', 18000),
												object_stat ('vehicles', 'kills', VEHICLE_TYPE_AVIATOR, 24))),

		#Air Defence Badge
			#Basic
			('1220104_1', 'adb',	1, object_stat ('vehicles', 'rtime', VEHICLE_TYPE_AIRDEFENSE, 300)),

			#Veteran
			('1220104_2', 'adb',	1, f_and( 	has_medal ('1220104_1'),
												#global_stat ('vtm-2', 3600),
												object_stat ('vehicles', 'kills', VEHICLE_TYPE_AIRDEFENSE, 10))),

			#Expert
			('1220104_3', 'adb',	1, f_and( 	has_medal ('1220104_2'),
												#global_stat ('vtm-2', 7200),
		...
		#Ground Defence Badge
			...
			#Veteran
			('1031923_2', 'Swb',	1, f_and( 	has_medal ('1031923_1'),
												#global_stat ('vtm-6', 3600),
												object_stat ('vehicles', 'kills', VEHICLE_TYPE_GRNDDEFENSE, 10))),

			#Expert
			('1031923_3', 'Swb',	1, f_and( 	has_medal ('1031923_2'),
												#global_stat ('vtm-6', 7200),
...
# Added by Chump - for bf2statistics stats
			...
			('3211305',	'Mur',	1, f_and(	player_stat ('timeInSquad', 300),
											player_score ('rplScore', 40))),

			#Infantry Officer Ribbon
			('3150914',	'Ior',	1, f_and(	global_stat ('twsc', 250),
											player_stat ('timeAsSql', 500))),

			#Staff Officer Ribbon
			('3151920',	'Sor',	1, f_and(	player_stat ('timeAsCmd', 500),
											player_score ('cmdScore', 50))),

			#Distinguished Service Ribbon
			('3190409',	'Dsr',	1, f_and(	global_stat ('tsqm', 7200),
											global_stat ('tsql', 7200),
											global_stat ('tcdr', 7200),
											player_score ('rplScore', 15))),

			#War College Ribbon
			('3242303',	'Wcr',	1, f_and(	global_stat ('tcdr', 5000),
											global_stat ('wins', 20),
											global_stat ('cdsc', 200))), 

			#Valorous Unit Ribbon
			('3212201',	'Vur',	1, f_and(	global_stat ('tsqm', 5000),
											global_stat ('tsql', 5000),
											player_score ('rplScore', 45))),

			#Legion of Merit Ribbon
			('3241213',	'Lmr',	1, f_and(	global_stat ('time', 10000),
											global_stat ('bksk', 10),
											global_stat ('wdsk', 2),
			...
			('3190318',	'Csr',	1, f_and(	f_plus(
												...
												player_score ('driverAssists'), 5),
											player_score ('kills', 5))),

			#Armoured Service Ribbon
			('3190118',	'Arr',	1, f_and(	object_stat ('vehicles', 'rtime', VEHICLE_TYPE_ARMOR, 1000),
			...
			#Good Conduct Ribbon 
			#Move to BACKEND??
			('3240703',	'gcr',	1, f_and(	global_stat ('time', 1800),
...
# Added by Chump - these are calculated in medals.py
			...
			('2191319',	'Msm',	2, f_and(	global_stat_multiple_times ('time', 8000, '2191319'),
			...
			#Combat Action Medal
			('2190303',	'Cam',	2, f_and(	global_stat_multiple_times ('time', 8000, '2190303'),
											global_stat_multiple_times ('kill', 250, '2190303'),
											global_stat ('bksk', 25),
											player_stat ('timePlayed', 1980))),

			#Air Combat Medal
			('2190309',	'Acm',	2, f_and(	global_stat_multiple_times ('vtm-1', 7200, '2190309'),
											global_stat_multiple_times ('vkl-1', 50, '2190309'),
											object_stat ('vehicles', 'kills', VEHICLE_TYPE_AVIATOR, 25))),

			#Armour Combat Medal
			('2190318',	'Arm',	2, f_and(	global_stat_multiple_times ('vtm-0', 7200, '2190318'),
											global_stat_multiple_times ('vkl-0', 50, '2190318'),
											object_stat ('vehicles', 'kills', VEHICLE_TYPE_ARMOR, 25))),

			#Helicopter Combat Medal
			('2190308',	'Hcm',	2, f_and(	global_stat_multiple_times ('vtm-3', 7200, '2190308'),
											global_stat_multiple_times ('vkl-3', 50, '2190308'),
											object_stat ('vehicles', 'kills', VEHICLE_TYPE_HELICOPTER, 30))),

			#Good Conduct MEDAL 
			#Move to BACKEND??
			('2190703',	'gcm',	2, f_and(	global_stat_multiple_times ('time', 900000, '2190703'),
			...
			('2020903',	'Cim',	1, f_and(	global_stat ('time', 7200),
											has_medal ('1031406_1'),
											has_medal ('1031619_1'),
											has_medal ('1031119_1'),
											has_medal ('1031120_1'),
			...
			#Medal of Valour
			('2021322',	'Mvm',	2, f_and(	global_stat_multiple_times ('time', 14400, '2021322'),
											global_stat_multiple_times ('dsab', 5, '2021322'),
											global_stat_multiple_times ('dfcp', 10,  '2021322'),
											global_stat_multiple_times ('twsc', 300, '2021322'))),

			#Distinguished Service Medal
			('2020419',	'Dsm',	2, f_and(	global_stat_multiple_times ('tcdr', 3600, '2020419'),
											global_stat_multiple_times ('tsql', 3600, '2020419'),
											global_stat_multiple_times ('tsqm', 3600, '2020419'),
											player_score ('rplScore', 45))),

# Added by Chump - added for bf2statistics
			#Navy Cross
			# Move to BACKEND ??
			# ('2021403',	'Ncm',	2, f_and(	global_stat_multiple_times ('atm-0', 3600, '2021403'),
											# global_stat_multiple_times ('abr-0', 100, '2021403'),
											# global_stat_multiple_times ('awn-0', 100, '2021403'))),

			#Golden Scimitar
			# Move to BACKEND ??
			# ('2020719',	'Gsm',	2, f_and(	global_stat_multiple_times ('atm-1', 3600, '2020719'),
											# global_stat_multiple_times ('abr-1', 100, '2020719'),
											# global_stat_multiple_times ('awn-1', 100, '2020719'))),

			#People's Medallion
			# Move to BACKEND ??
			# ('2021613',	'pmm',	2, f_and(	global_stat_multiple_times ('atm-2', 3600, '2021613'),
