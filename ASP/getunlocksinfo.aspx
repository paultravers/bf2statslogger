 ...
 *                 - Fixed unlocks          *
 * 07/27/06 v0.1.3 - Added unlock tier support	*
*  07/27/06 v0.1.4 - Added bonus unlock support	*
 ********************************************/
...
else
{
	...
	switch ($cfg->get('game_unlocks'))
	{
		case 0:
			...
			if (!mysql_num_rows($result)) {die('Player not found!');}
